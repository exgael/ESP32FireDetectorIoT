...
static bool _start_async_task() {
    ...
    if (!_async_service_task_handle) {
        xTaskCreateUniversal(_async_service_task, "async_tcp", 8192 * 2, NULL, 3, &_async_service_task_handle,
...
bool AsyncClient::operator==(const AsyncClient &other) { return _pcb == other._pcb; }
...
bool AsyncClient::canSend() { return space() > 0; }
...
int8_t AsyncClient::_s_poll(void *arg, struct tcp_pcb *pcb) { return reinterpret_cast<AsyncClient *>(arg)->_poll(pcb); }
...
void AsyncClient::_s_error(void *arg, int8_t err) { reinterpret_cast<AsyncClient *>(arg)->_error(err); }
