...
class AsyncWebServerRequest {
   ...
   public:
    ...
    bool authenticate(const char* username, const char* password, const char* realm = NULL,
    ...
    AsyncWebServerResponse* beginResponse(FS& fs, const String& path, const String& contentType = String(),
                                          bool download = false, AwsTemplateProcessor callback = nullptr);
...
class AsyncWebHandler {
   ...
   public:
    ...
    virtual void handleUpload(AsyncWebServerRequest* request __attribute__((unused)),
                              ...
                              uint8_t* data __attribute__((unused)), size_t len __attribute__((unused)),
                              bool final __attribute__((unused))) {}
    virtual void handleBody(AsyncWebServerRequest* request __attribute__((unused)),
                            uint8_t* data __attribute__((unused)), size_t len __attribute__((unused)),
                            size_t index __attribute__((unused)), size_t total __attribute__((unused))) {}
...
typedef std::function<void(AsyncWebServerRequest* request, const String& filename, size_t index, uint8_t* data,
...
class DefaultHeaders {
    ...
    DefaultHeaders() : _headers(headers_t([](AsyncWebHeader* h) { delete h; })) {}
