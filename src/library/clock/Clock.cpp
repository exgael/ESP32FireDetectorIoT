...
Clock::Clock() : startTime(millis()), lastUpdate(millis()), deltaTime(0), elapsedTime(0) {}
...
unsigned long Clock::getDeltaTime() const { return deltaTime; }
unsigned long Clock::getElapsedTime() const { return elapsedTime; }
